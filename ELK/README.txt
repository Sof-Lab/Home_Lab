...
1. В docker-compose.yml добавлен контейнер vector.
2. Сконфигурированы файл 70-output.conf для отправки rsyslog всех логов в vector.
3. Сконфигурирован файл vector.yaml с фильтрацией и изменением логов, а также с отправкой в elasticsearch.

Конфигурационные файлы лежат в Vector Configs.